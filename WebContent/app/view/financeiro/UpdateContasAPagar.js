Ext.define('App.view.financeiro.UpdateContasAPagar', {
			extend : 'Ext.panel.Panel',
			alias : 'widget.updatecontasapagar',
			itemId : 'updatecontasapagar',
			...
			requires : ['Ext.form.*','Ext.form.Panel', 'Ext.form.field.Text','App.view.financeiro.UpdateDivisaodeRateioContasAPagarList',
					...
					'Ext.ux.InputTextMask', 'App.util.CpfField','App.view.financeiro.UpdateParcelasAPagarList'
			],
       ...
       itemId:'formUpdateContasAPagar',
        ...
        items: [
        	...
        	items: [ {
					...
					forceSelection : true,
					autoSelect : true,
					store : 'App.store.ComboContasAPagarFornecedor',
					queryMode : 'local',
					allowBlank : false,
					//ancor : '-10',
					typeAhead : true,
    ...
    //autoScroll : true,
       xtype:'UpdateDivisaodeRateioContasAPagarList',
    ...
    //autoScroll : true,// Results grid specified as a config object with an xtype of 'grid'
        xtype: 'UpdateParcelasAPagarList',
    ...
    initComponent : function() {
				...
				this.dockedItems = [{
							xtype : 'toolbar',
							dock : 'bottom',
							id : 'buttonUpdateContasAPagar',
							//ui: 'footer',
							items : [ {
										xtype : 'button',
										text : 'Lançar Pagamento',
										itemId : 'updatelancacontasapagar',
										iconCls : 'addcontatofornecedor'
									},'->',{
										xtype : 'button',
										text : 'Ok',
										formBind:true,
										itemId : 'updateaddcontasapagar',
										iconCls : 'liberar'
									},{
										xtype : 'button',
										text : 'Cancel',
										itemId : 'updatecancelcontasapagar',
										iconCls : 'cancel'
									}]
						}];

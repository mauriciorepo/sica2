...
Ext.define('App.view.financeiro.ParcelasAPagarList', {
extend: 'Ext.grid.Panel',
alias: 'widget.ParcelasAPagarList',
itemId:'ParcelasAPagarList',
height: 300,
autoScrol:true,
closeAction:'hide',
selType:'cellmodel',
...
//frame: true,
store: Ext.create('App.store.ParcelasAPagar'), // #1 
			...
			initComponent : function() {
				...
				this.dockedItems = [{
							...
							items : [ {
										...
										xtype : 'button',
										text : 'Add Parcela',
										name:'addparcelacontasapagar',
										itemId : 'addparcelacontasapagar',

...
Ext.define('App.view.suprimentos.CadastroFornecedorComercial', {
			extend : 'Ext.form.FormPanel',
			alias : 'widget.fornecedorcomercial',
			itemId : 'fornecedorcomercial',
			...
			items : [{
						items : [{
									 ...
									 * { xtype : 'combobox', // 9 fieldLabel :
									 * 'Natureza ', labelAlign : 'top',
									 * afterLabelTextTpl :
									 * App.util.Util.required, valueNotFoundText :
									 * 'Valor não corresponde', forceSelection :
									 * true,
									 * 
									 * displayField : 'name', anchor : '-10',
									 * valueField : 'id', store :
									 * Ext.create('Ext.data.Store', { fields : [{
									 * type : 'string', name : 'name' }, { type :
									 * 'string', name : 'id' }], data : [{
									 * "name" : "Pessoa Fisica", "id" : "F" }, {
									 * "name" : "Pessoa Juridica", "id" : "J" }]
									 * }), queryMode : 'local', typeAhead :
									 * true, itemId : 'tipo', name : 'tipo' },
									 */{
									xtype : 'textfield',

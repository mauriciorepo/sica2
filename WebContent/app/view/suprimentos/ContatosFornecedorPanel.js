Ext.define('App.view.suprimentos.ContatosFornecedorPanel', {
			extend : 'Ext.panel.Panel',
			alias : 'widget.ContatosFornecedortopanel',
			itemId:'ContatosFornecedortopanel',
			//title:'Movimento',
			requires : [

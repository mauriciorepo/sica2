...
Ext.define('App.util.SessionMonitor', {
  ...
  window: Ext.create('Ext.window.Window', {
    ...
    items: [{
      xtype: 'container',
      frame: true,
      html: "Sua sessão ira autometicamente expirar depois de 15 minutos de inatividade. Se a sua sessão expirar, todos os dados não salvos serão perdidos e voce ira automaticamente ser direcionado para pagina de login. </br></br>If you want  to continue working, click the 'Continue Working'  button.</br></br>"    
    },{
      xtype: 'label',
      text: ''
    }],

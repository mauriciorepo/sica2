Ext.define('App.store.ContatosFornecedor', {
 extend: 'Ext.data.ArrayStore',
    //requiers:['Ext.data.proxy.Memory','Ext.data.reader.Array'],
 storeId: 'StoreContatosFornecedor',   
 fields:[
	    'idcontatofornecedor','nome','cargo','email','telefone','telefone2','fornecedores_idfornecedores'
